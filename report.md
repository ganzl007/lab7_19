...
subtitle: "Модель распространения рекламы - вариант 19"
author: "Гань Чжаолун"
...
model pr7
parameter Real a = 0.00006;
parameter Real b = 0.72;
parameter Real N = 1003;
...
equation
  der(n) = (a*cos(3*time)+b*cos(2*time)*n) * (N-n);
...
function syst(dy, y, p, t)
    dy[1] = (a*cos(3*t)+b*cos(2*t)*y[1])*(N-y[1])
end
